...
const EXPENSE_CATS = ["외식", "술/유흥", "의류/미용", "의료/건강", "교통", "주거/공과금", "생필품", "문화/여가", "여행", "교육", "육아", "경조사", "기타"];
const INCOME_CATS = ["급여", "부수입", "기타수입"];

// ──────── 이용내역서 파서 ────────
const CAT_KW = {
  "외식":      ["마트","편의점","GS25","CU","세븐","이마트","롯데마트","홈플러스","코스트코","농협하나로","쿠팡로켓","SSG","노브랜드","트레이더스","다이소","위마트","배달의민족","배민","쿠팡이츠","요기요","맥도날드","버거킹","KFC","롯데리아","서브웨이","치킨","피자","족발","보쌈","냉면","해장국","분식","김밥","고기집","삼겹","갈비","순대","떡볶이","초밥","덮밥","짜장","짬뽕","돈까스","우동","라멘","식당","음식점","스타벅스","이디야","투썸","커피빈","할리스","탐앤탐스","빽다방","메가커피","컴포즈","카페","베이커리","파리바게뜨","뚜레쥬르","설빙","베스킨","던킨","도넛","마카롱","크리스피","공차","코코","요거트","와플"],
